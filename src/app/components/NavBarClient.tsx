...
const NavBarClient = () => {
  ...
  return (
    <nav className="bg-gradient-to-br from-cyan-100 via-gray-100 to-white dark:from-cyan-900 dark:via-gray-800 dark:to-gray-700 p-8 md:p-5 text-gray-900 dark:text-white sticky top-0 z-50">
